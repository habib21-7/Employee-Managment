                ...
                <div class="container-fluid" style="display: flex;gap: 30px">
                    <div class="form">
                        <form class="form-inline" method="post" action="{{url('/search')}}" >
                            ...
                            <br>
                            <input class="form-control" name="query" type="text" placeholder="Enter Name">
                    ...
                    <div class="collapse navbar-collapse"   id="bs-example-navbar-collapse-1">
                        <div class="nav navbar-nav navbar-right">
                            <li>
                                <a href="{{route('employee.show')}}" class="btn" style="color: black;margin-left: 100px; background-color: #6d7fcc">Show All Employees</a>
                            </li>
                        </div>
                    </div>
                </div>
