                ...
                <div class="container-fluid">
                    <div class="form">
                        <form class="form-inline" method="post" action="{{url('/search2')}}">
                            ...
                            <br>
                            <input class="form-control" name="query2" type="search" placeholder="Enter Name">
                ...
                <div class="container">
                    ...
                    <table class="table table-bordered">
                        ...
                        @foreach($departments as $department)
                            ...
                            <td>
                                 <a href="{{route('department.employees',$department -> id)}}" class="btn " style="color: black;background-color: #6d7fcc">Show Employees</a>
                            </td>
                            </tbody>
                        @endforeach
                    </table>
